...
@description('Base URL for IPAFFS Field Config Microservice')
param fieldConfigServiceBaseUrl string
  ...
  properties: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        {
          name: 'ApiConfig__FieldConfigServiceBaseUrl'
          value: fieldConfigServiceBaseUrl
        }
      ]
    }
  }
